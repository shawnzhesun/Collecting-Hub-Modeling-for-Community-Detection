...
/* debug.c */
void fitToPiecewiseUniform (float *, int, float, float, float *, float *);
...
int ComputeCoarseGraphSize (int, idxtype *, idxtype *, int, idxtype *,
			    idxtype *, idxtype *);
...
void SetUpGraph2 (GraphType *, int, int, idxtype *, idxtype *, float *,
		  idxtype *);
void VolSetUpGraph (GraphType *, int, int, int, idxtype *, idxtype *,
		    idxtype *, idxtype *, int);
...
Matrix *normBcMatrix (int, int *, int *, int *, int *, int *, float, float);
void l2Normalize (Matrix *);
Matrix *reorderDimensionsAndVectors (Matrix *, idxtype *, wgttype *,
				     wgttype *, idxtype *);


Matrix *bayesianSimSearch (Matrix *, Beta, float, float, float, float);
float *sampleUnprunedPairs_wrapper (GraphType *, int, float);
float *sampleSimilarities (GraphType *, int);
void getInAndOutDegrees (int, idxtype *, idxtype *, idxtype **, idxtype **);
void convertMatrixToGraph (Matrix *,
			   idxtype **, idxtype **, idxtype **, wgttype scale =
			   0);
void addGraphs (int, idxtype *, idxtype *, idxtype *, idxtype *, idxtype *,
		idxtype *, idxtype **, idxtype **, idxtype **);
void symmetrize_pagerank (GraphType *, idxtype **, idxtype **, idxtype **,
			  PageRankOptions);
void getReverseGraph (int, int, idxtype *, idxtype *, idxtype *, idxtype **,
		      idxtype **, idxtype **);
void convert_directed (int *, idxtype *, idxtype *, idxtype *, idxtype *,
		       idxtype *, idxtype *, idxtype **, idxtype **,
		       idxtype **);
void symmetrize_directed (const int, idxtype *, idxtype *, idxtype *,
			  idxtype *, idxtype *, idxtype *, idxtype **,
			  idxtype **, idxtype **, DirToUndirOptions);
void usual_symmetrize_directed (int, int, idxtype *, idxtype *, idxtype *,
				idxtype **, idxtype **, idxtype **, int);
void *bcWithThreshold_thread (void *);
Matrix *bcWithThreshold (int, idxtype *, idxtype *, idxtype *, float);
...
Matrix *setupCanonicalMatrix (int, int, idxtype *, idxtype *, idxtype *, int);
...
Matrix *expand_ht (Matrix *, Matrix *, idxtype *, int, wgttype threshold = 0);
...
/* subgraphs.c */
int selfLoopifyHubs (int, idxtype *, idxtype *, idxtype *, wgttype *, int);
...
void assignClustersToHubs (idxtype *, idxtype *, int, int, GraphType *);
void dfTraversalMatrix (Matrix *, idxtype, idxtype *, int *, wgttype minWgt);
...
void ParallelQSortIntsUsingScores (idxtype *, idxtype *, idxtype *, int, int);
...
void WriteGraphWithWts (const char *, int, idxtype *, idxtype *, idxtype *);
 ...
 * Yiye Ruan
 */
GraphType *mergeHeteroGraphs (GraphType *, GraphType *, int *, int);
void readList (GraphType *, const char *, idxtype);
GraphType *getSingleBagSparsifiedGraph (GraphType *, GraphType *, GraphType *,
					int, float);
Hashtable *buildSingleBagHashtable (GraphType *, GraphType *, int, int *);
GraphType *getSimWeightedSparsifiedGraph_jac (GraphType *, GraphType *, GraphType *, int, float, double, int);
GraphType *getSimWeightedSparsifiedGraph_cos (GraphType *, GraphType *, GraphType *, int, float, double, int);
Hashtable *buildZeroFriendlyHashtable (GraphType *, int, int *);
void compLocationAndScale_double(const idxtype, const double *, const idxtype, const idxtype, const idxtype *, const idxtype, const double, const double, double *, double *);
void compLocationAndScale_int(const idxtype, const idxtype *, const idxtype, const idxtype, const idxtype *, const idxtype, const idxtype, const idxtype, double *, double *);
double compCosSim(const idxtype, const idxtype, const idxtype *, const idxtype, const idxtype, const idxtype, const idxtype);
idxtype getSetUnionSize (const idxtype *, const idxtype *, const idxtype *, const idxtype *);
void retainSimWeightedTopNeighbors (GraphType *, IntDoublePair *, float);
void sortAdjListsByAdjwgt (GraphType *, IntDoublePair *);
int intDoublePairCmp (const void *, const void *);
void getMinHashKeys (const idxtype * const, int, const int *const, int,
		     int *const, int *const, int);
void dumpNetwork (const char *, GraphType *);

/* 
 * cosLSH.c
 * Yiye Ruan
 */
chunktype *generateHashTable(const GraphType * const, const int);
void populateHashTable(chunktype * const , const int , const int , const projtype * const , const GraphType * const );
void packBits(const int * const , const int , const int , chunktype * const );
void populateProjTable(projtype * const , const size_t );
size_t getUniverseSize(const GraphType * const );
size_t countBitSet(chunktype );
double cosSimByLSH(const size_t , const size_t , const chunktype * const , const GraphType * const , const int , const int );
